...
function Input(props) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(InputWrapper$4, { ...rest, onChange: handleChange });
}
const InputWrapper$4 = newStyled.input`
  width: 100%;
  ...
  font-size: 11px;
`;
function useInputFocus({ inputValueLength }) {
  const inputRef = reactExports.useRef([]);
  const handleChange = (i) => {
    var _a, _b;
    const inputLength = (_a = inputRef.current[i]) == null ? void 0 : _a.value.length;
    if (inputLength === inputValueLength) {
      (_b = inputRef.current[i + 1]) == null ? void 0 : _b.focus();
    }
  };
...
function CardNumberField({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Label$4, { htmlFor: "cardNumber-0", id: "cardNumber", children: "카드 번호" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(InputWrapper$3, { children: cardNumber.map((v, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Input,
      {
        ref: (el) => {
          if (el) {
...
const InputWrapper$3 = newStyled.div`
  display: flex;
  gap: 10px;
  margin-top: 8px;
`;
const Label$4 = newStyled.label`
  font-size: 12px;
`;
function CardCVCField({ isError, cardCVC, onChange }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Label$3, { htmlFor: "CardCVC", children: "CVC" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(InputWrapper$2, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Input,
      {
        isError,
        type: "tel",
...
const InputWrapper$2 = newStyled.div`
  display: flex;
  gap: 10px;
  margin-top: 8px;
`;
const Label$3 = newStyled.label`
  font-size: 12px;
`;
function CardCompanySelect({ cardCompany, onChange }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Label$2, { htmlFor: "CardCompany", children: "카드사" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { id: "CardCompany", onChange, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: cardCompany, disabled: true, hidden: true, selected: true, children: "카드사를 선택해주세요" }),
      CARD_COMPANY.map(({ name }) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: name, children: name }))
    ] })
  ] });
}
...
function CardValidityPeriodField({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: `cardValidityPeriod-${id}-${month}`, children: "유효기간" }),
...
function CardPasswordField({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "cardPassword", children: "비밀번호 앞 2자리" }),
...
const Label = newStyled.label`
  font-size: 12px;
`;
const checkValideDate = (monthString, yearString) => {
...
function CardPreview({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { color: (_a = CARD_COMPANY.find((e) => e.name === cardCompany)) == null ? void 0 : _a.color, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardInfoWrapper, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        month !== "" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
          month,
          "/"
        ] }) : null,
    ...
    imgPath && /* @__PURE__ */ jsxRuntimeExports.jsx(CardLogo, { src: imgPath })
  ] });
}
const Card = newStyled.div`
  width: 212px;
  height: 132px;
  border-radius: 4px;
...
const IcChip = newStyled.div`
  ...
  position: absolute;
`;
const CardInfoWrapper = newStyled.div`
  display: flex;
  ...
  color: #ffffff;
`;
const CardNumberWrapper = newStyled.div`
  display: flex;
  gap: 10px;
`;
...
const validateExpiry = (monthStr, yearStr, focueType) => {
...
function formReducer(state, action) {
  switch (action.type) {
    case "VALIDATE_CARD_NUMBER": {
      ...
      const message = errors.some(Boolean) ? "카드 번호는 4자리씩 입력해야 합니다." : "";
      return {
        ...state,
...
function useCardValidationError({
  ...
  const [state, dispatch] = reactExports.useReducer(formReducer, initialState);
  const validateCardNumber = (cardNumber2) => dispatch({ type: "VALIDATE_CARD_NUMBER", payload: { cardNumber: cardNumber2 } });
  const validateCardCVC = (cardCVC2) => dispatch({
    type: "VALIDATE_CARD_CVC",
    payload: { cardCVC: cardCVC2 }
  });
  const validatePeriod = (year, month, type) => {
    dispatch({
  ...
  const validatePassword = (cardPassword) => {
    dispatch({
  ...
  reactExports.useEffect(() => {
    if (state.isCardNumberError.every((e) => !e) && cardNumber.every((e) => e !== "")) {
      showNextStep(CARD_IFNO_INPUT_STEP.cardCompany);
    }
    if (Object.values(state.isErrorCardValidityPeriod).every((e) => !e) && Object.values(cardValidityPeriod).every((e) => e !== "")) {
...
function CardForm({
  ...
  const onChangeCardNumber = (e, i) => {
    const copy2 = [...cardNumber];
    copy2[i] = e.target.value;
    setCardNumber(copy2);
    validateCardNumber(copy2);
  };
  ...
  const onChangeCardValidityPeriod = (e, type) => {
    const copy2 = { ...cardValidityPeriod };
    const { value } = e.target;
    if (type === "month") copy2.month = value;
    if (type === "year") copy2.year = value;
    setCardValidityPeriod((prev2) => ({
      ...prev2,
      [type]: value
    }));
    validatePeriod(copy2.year, copy2.month, type);
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Form, { onSubmit: handleSubmit, children: [
    show.password && /* @__PURE__ */ jsxRuntimeExports.jsx(
      CardInputSection,
      {
        title: "비밀번호를 입력해 주세요",
    ...
    show.cvc && /* @__PURE__ */ jsxRuntimeExports.jsx(
      CardInputSection,
      {
    ...
    cardCompany && /* @__PURE__ */ jsxRuntimeExports.jsx(
      CardInputSection,
      {
    ...
    show.cardCompany && /* @__PURE__ */ jsxRuntimeExports.jsx(
      CardInputSection,
      {
        title: "카드사를 선택해 주세요",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(SubmitButton, { disabled: !checkIsValid(), isError: !checkIsValid(), children: "확인" })
  ] });
}
...
const AppLayout = newStyled.main`
  width: 376px;
  height: 100%;
  display: flex;
  flex-direction: column;
...
function Completion() {
  ...
  const cardType = companyNameEnd === "카드" ? companyName : `${companyName}카드`;
  const handleClick = () => {
    navigate("/", { replace: true });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Img, { src: "./check.png" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Text, { children: [
      (_a = location.state) == null ? void 0 : _a.startCardNumber,
      "로 시작하는",
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      cardType,
      "가 등록되었어요."
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: handleClick, children: "확인" })
  ] });
}
...
ReactDOM.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Router, {}) })
);
