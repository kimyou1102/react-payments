...
function Input(props) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(InputWrapper$3, { ...props });
}
const InputWrapper$3 = newStyled.input`
  width: 100%;
...
function CardNumberField({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Label$2, { htmlFor: "cardNumber-0", id: "cardNumber", children: "카드 번호" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(InputWrapper$2, { children: cardNumber.map((v, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Input,
      {
